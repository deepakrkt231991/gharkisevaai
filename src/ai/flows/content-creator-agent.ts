...
const contentCreatorFlow = ai.defineFlow(
  ...
  async ({ workerName, workerPhotoUri }) => {
    const { media } = await ai.generate({
      ...
      prompt: `Create a professional and eye-catching promotional poster for a verified home service worker named ${workerName} for the "GHAR KI SEVA AI" app. The poster is intended to be shared on WhatsApp Status.

      It must include the following text in a prominent, stylish Hindi font: "मैं GHAR KI SEVA AI पर वेरिफाइड वर्कर हूँ, मुझे जॉइन करें!"
