...
const InteriorDesignOutputSchema = z.object({
  suggestions: z.array(z.string()).describe("A list of actionable suggestions for improving the room's layout, color scheme, and decor based on Vastu and modern interior design trends."),
...
2.  **Provide Suggestions:** Based on your analysis, provide a list of actionable suggestions to improve the room. These suggestions should:
